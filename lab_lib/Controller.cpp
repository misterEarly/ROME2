...
void Controller::run() {
  ...
  while (true) {
    ...
    // translational vel ist in m/s
    // rotational vel ist in rad/s
    // zähler ergibt m/s, nenner teilt es durch den umfang, um rps zu bekommen
    // mal 60, um von rps auf rpm zu gelangen
